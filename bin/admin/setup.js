...
const options = yargs
    .usage("Usage: xedge-setup-env --tkn_url <Token URL> --aud_url <Audience Url> --adm_url <Admin URL> --key_url <Preview URL>")
    ...
    .example("xedge-setup-env --tkn_url https://one-sc-beta.eu.auth0.com/oauth/token --aud_url https://delivery.sitecore-beta.cloud/tenant_id --adm_url https://edge-beta.sitecorecloud.io/api/admin/v1 --key_url https://edge-beta.sitecorecloud.io/api/apikey/v1")
    .argv;
